...
import { ProductAction } from "../../components/ui/product-action";
...
export default function ProductDetail() {
  ...
  return (
    <div className="px-5 lg:px-10  xl:max-w-7xl mx-auto flex flex-col md:flex-row items-center md:items-start  gap-11.25 mt-10">
